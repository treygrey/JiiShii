// =============================================================================
// Scene validator — the loud half of "unfuckuppable". Walks every scene at
...
export function validateScenes(registry, options = {}) {
  ...
  const surfaceIds = new Set(createSurfaceRegistry(options.surfaceModules).keys());
